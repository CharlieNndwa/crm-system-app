...
const Dashboard = () => {
    ...
    // This useEffect will re-run whenever the component mounts or the state changes,
    // ensuring the data is always fresh. You can also add dependencies to trigger it.
    useEffect(() => {
